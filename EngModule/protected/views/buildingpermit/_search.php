...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'app_num',array('size'=>50,'maxlength'=>50)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'requested_by',array('size'=>50,'maxlength'=>50)); ?>
	</div>
